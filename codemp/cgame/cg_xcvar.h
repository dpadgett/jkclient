...
XCVAR_DEF( cg_noAutoDemo,						"0",					NULL,					CVAR_ARCHIVE|CVAR_NORESTART )
XCVAR_DEF( cg_demoData,							"",					  NULL,					CVAR_NORESTART|CVAR_INTERNAL )
XCVAR_DEF( cg_demoName,							"",					  NULL,					CVAR_NORESTART|CVAR_INTERNAL )
XCVAR_DEF( cg_newHud,							  "0",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_fixDemoScores,				"0",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_forceTeamModel,				"0",					CG_ForceModelChange, CVAR_ARCHIVE )
XCVAR_DEF( cg_friendModel,					"",	  				CG_ForceModelChange, CVAR_ARCHIVE )
XCVAR_DEF( cg_enemyModel,						"",		  			CG_ForceModelChange, CVAR_ARCHIVE )

XCVAR_DEF( cg_drawSpeed,						"0",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_drawAccel,						"0",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_disableJPMOTD,				"1",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cl_checksumProblem,			"0",					NULL,					CVAR_ROM )
XCVAR_DEF( cl_wwwDownload,					"1",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cl_triedDownload,		  	"0",					NULL,					CVAR_ROM )
XCVAR_DEF( cl_wwwBaseUrl,				  	"http://pug.jactf.com/mapdl.php/", NULL, CVAR_ARCHIVE )
XCVAR_DEF( cg_drawFlagDrop,					"0",					NULL,					CVAR_ARCHIVE )
